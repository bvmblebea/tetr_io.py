...
class TetraChannel:
    ...
    def get_user_records(self, username: str):
        return get(
    ...
    def get_league_leaderboard_full(self, country: str = "US"):
        return get(
    ...
    def get_latest_news(self, limit: int = 25):
        return get(
            f"{self.api}/news?limit={limit}",
            headers=self.headers).json()

    def get_stream_latest_news(self, stream: str, limit: int = 25):
        return get(
